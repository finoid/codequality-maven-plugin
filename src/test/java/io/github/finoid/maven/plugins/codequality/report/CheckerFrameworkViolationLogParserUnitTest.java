...
class CheckerFrameworkViolationLogParserUnitTest extends UnitTest {
    @Mock
    private MavenProject project;

    private CheckerFrameworkViolationLogParser unit;

    @BeforeEach
    void beforeEach() {
        unit = new CheckerFrameworkViolationLogParser(new ViolationConverter(project));
    }

    @Test
    void givenValidLogFile_whenParse_thenExpectedViolations() {
        var logFileInputStream = ResourceUtils.tryInputStreamFrom("files/checkerframework-logs.template.txt");
